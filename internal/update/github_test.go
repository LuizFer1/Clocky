...
func TestRepoSlugOverride(t *testing.T) {
	t.Setenv("CLOCKY_GITHUB_REPO", "acme/fork")
...
func TestLatestRelease(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write([]byte(`{
			"tag_name": "v1.2.0",
			"assets": [
				{"name": "clocky_1.2.0_windows_amd64.zip", "browser_download_url": "https://example.com/a.zip"},
	...
	url, err := FindAssetURL(rel, "clocky_1.2.0_windows_amd64.zip")
